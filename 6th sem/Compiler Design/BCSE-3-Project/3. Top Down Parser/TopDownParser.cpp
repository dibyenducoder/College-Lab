...
class TopDownParser
{
    ...
    //mapping for terminals and non terminals 
	void setMaps()
	{
		for(int i=0;i<nt.size();i++)
		{
	...
	//details are provided in readme (Introduction)
	void leftRecursion()
	{
		int n=nt.size();
		int i,j,k,t1,t2;
...
void readFromfile(string filename)
{
	...
	cout<<endl<<"Original productions ---"<<endl<<endl;
	TP.printProductions();
	...
	TP.setMaps(); //list of terminals and non terminals are provided in this map
	...
	TP.constructTable();
	cout<<endl<<"Construction of Table"<<endl;
	cout<<"---------------------------------------"<<endl<<endl;
	cout<<"(row,coln)"<<endl;
	TP.printTable();
