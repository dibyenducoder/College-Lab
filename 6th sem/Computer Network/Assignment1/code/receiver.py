...
def modules():
	...
	list_of_frames=readfile('Trans_Medium_LRC.txt',no_of_bits+len(err.generator_poly)-1)
	check_lrc(list_of_frames, no_of_bits)

	list_of_frames=readfile('Trans_Medium_VRC.txt',no_of_bits+len(err.generator_poly)-1)
	check_vrc(list_of_frames)

	list_of_frames=readfile('Trans_Medium_Checksum.txt',no_of_bits+len(err.generator_poly)-1)
	check_checksum(list_of_frames, no_of_bits)

	list_of_frames=readfile('Trans_Medium_CRC.txt',no_of_bits=err.no_of_bits_crc+len(err.generator_poly)-1)
