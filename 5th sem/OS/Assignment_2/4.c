...
#include <semaphore.h>
#include <sys/wait.h>
#include <sys/mman.h> //memory management description for mmap()
#include <sys/stat.h>
#include <fcntl.h>
#include <unistd.h>
...
int main()
{
    ...
    printf("Enter reader number: "); //multiple reader 
    scanf("%d", &rc);
    printf("Enter writer number: "); // can either be 1 writer (4.a) or multiple writer (4.b)
    scanf("%d", &wc);
